        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    @else
                        @if ($action === 'edit')
                            @if (file_exists(public_path('storage/puntos/' . $image)))
                                <img class="img-fluid img-thumbnail" src="{{ asset('storage/puntos/' . $image) }}"
                                    alt="">
                            @else
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="tipo_id">Tipo</label><span class="ms-1 text-danger fs-6 fw-semibold">*</span>
                            <select class="form-select {{ $preview ? 'nocursor' : '' }}" wire:model="tipo_id"
                                @disabled($preview)>
