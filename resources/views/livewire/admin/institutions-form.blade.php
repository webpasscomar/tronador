        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="name">Nombre</label><span class="ms-1 text-danger fs-6 fw-semibold">*</span>
                ...
                <div class="form-group">
                    <label for="initial">Sigla</label><span class="ms-1 text-danger fs-6 fw-semibold">*</span>
                    <input type="text" class="form-control" wire:model="initial"/>
                    @error('initial')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
